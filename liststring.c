 ...
 * @head: is an address of pointer to head node
 * @str: is the str field of node
 ...
 * @head: is an address of pointer to first node
 * @index: is the index of node to delete
 *
 ...
 * @head_ptr: is an address of pointer to head node
 *
 * Return: void
 */
