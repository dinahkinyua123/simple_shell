...
/**
 * is_chain - this test if current char in buffer is a chain delimeter
 * @info: is the parameter struct
 * @buf: is the char buffer
 * @p: is an address of current position in buf
 *
...
/**
 * check_chain - this checks should continue chaining based on last status
 * @info: is the parameter struct
 * @buf: is the char buffer
 * @p: is an address of current position in buf
...
/**
 * replace_string - this func replaces string
